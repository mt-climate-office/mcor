#' Simplified polygons of Montana Climate Divisions
#'
#' A dataset containing polygons of Montana climate divisions.
#' These data are derived from the [mt_counties_simple] dataset;
#' county borders were dissolved using the [sf::summarize.sf()][sf::dplyr] function.
#' This process ensures the extent of the state is the same as the [mt_counties_simple] dataset.
